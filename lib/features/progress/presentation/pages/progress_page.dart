      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            Text('Rekordy osobiste (PR)',
                style: Theme.of(context).textTheme.titleMedium?.copyWith(fontWeight: FontWeight.w700)),
            const SizedBox(height: 8),
            prsAsync.when(
              data: (list) => list.isEmpty
                  ? const Text('Brak PR - wykonaj pierwszy trening z ciężarem', style: TextStyle(color: Colors.grey))
                  : Column(
                      children: list
                          .take(10)
                          .map((pr) => Card(
                                ...
                                child: ListTile(
                                  ...
                                  trailing: Text('1RM≈${pr.szacowane1Rm.toStringAsFixed(1)}kg'),
                                ),
                              ))
                          .toList(),
                    ),
            ...
            measurementsAsync.when(
              data: (list) => list.isEmpty
                  ? const Text('Brak pomiarów - dodaj pierwszy pomiar', style: TextStyle(color: Colors.grey))
                  : Column(
                      children: list
                          .take(10)
                          .map((m) => Card(
